...
<head>
    ...
    <title>403 — Access Denied | NCMB CMMS</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style nonce="{{ $cspNonce }}">
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        body {
            font-family: Arial, sans-serif;
            background: linear-gradient(135deg, #7c1d1d 0%, #b91c1c 40%, #991b1b 100%);
            min-height: 100vh;
            display: flex;
            align-items: center;
        ...
        .reason-box i { font-size: 16px; flex-shrink: 0; }
        .btn-group {
            display: flex;
            gap: 12px;
            justify-content: center;
...
<body>
    <div class="card">
        ...
        @else
            <div class="reason-box">
                <i class="fa-solid fa-circle-exclamation"></i>
                <span>Your role does not allow access to this resource. Please contact your administrator if you believe this is an error.</span>
            </div>
        @endif
