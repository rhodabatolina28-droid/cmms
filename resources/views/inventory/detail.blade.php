                ...
                <div class="attach-item">
                    ...
                    <div class="attach-info">
                        ...
                        <div class="attach-meta">
                            @if($att->label)<span class="attach-label">{{ $att->label }}</span> · @endif
                            Uploaded by {{ $att->uploader?->full_name ?? 'Unknown' }} · {{ $att->created_at->format('M d, Y') }}
                            · {{ $att->file_size }}
                        </div>
                    </div>
        ...
        <div class="scrap-box">
            ...
            <div class="scrap-body">
                ...
                <div class="scrap-info">
                    ...
                    <div class="scrap-asset-details">SN: {{ $asset->serial_number ?? 'N/A' }} · PAR: {{ $asset->par_number ?? 'N/A' }} · Prop#: {{ $asset->property_number ?? 'N/A' }}</div>
                </div>
