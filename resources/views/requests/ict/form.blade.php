                            ...
                            <div class="signature-wrapper">
                                <div class="signature-container" id="endUserSignatureContainer">
                                    @if(!empty($repairRequest->end_user_signature))
                                        <img src="{{ route('tickets.signature.show', ['ticket' => $repairRequest->request->id ?? 0, 'field' => 'end_user_signature']) }}" class="signature-preview" alt="Signature" id="endUserSignatureImg">
