                            ...
                            <div class="signature-wrapper">
                                <div class="signature-container">
                                    @if(!empty($repairRequest->technician_signature))
                                        <img src="{{ route('tickets.signature.show', ['ticket' => $repairRequest->request->id ?? 0, 'field' => 'technician_signature']) }}" class="signature-preview" alt="Technician Signature">
                            ...
                            <div class="signature-wrapper">
                                <div class="signature-container">
                                    @if(!empty($repairRequest->it_personnel_signature))
                                        <img src="{{ route('tickets.signature.show', ['ticket' => $repairRequest->request->id ?? 0, 'field' => 'it_personnel_signature']) }}" class="signature-preview" alt="IT Personnel Signature">
                            ...
                            <div class="signature-wrapper">
                                <div class="signature-container">
                                    @if(!empty($repairRequest->end_user_acceptance_signature))
                                        <img src="{{ route('tickets.signature.show', ['ticket' => $repairRequest->request->id ?? 0, 'field' => 'end_user_acceptance_signature']) }}" class="signature-preview" alt="End-User Acceptance Signature">
