...
@section('styles')
    <style nonce="{{ $cspNonce }}">
        ...
        .status-defective { background: #fef2f2; color: #991b1b; border: 1px solid #fee2e2; }
        .status-spare { background: #f3f4f6; color: #374151; border: 1px solid #e5e7eb; }
                ...
                <table class="gov-table-premium">
                    <thead>
                        <tr>
                            ...
                            <th class="th-center">Condition</th>
