...
@section('styles')
    <style nonce="{{ $cspNonce }}">
        ...
        .sp-pending { background: #fff7ed; color: #c2410c; border: 1px solid #ffedd5; }
        .sp-ongoing { background: #eff6ff; color: #1d4ed8; border: 1px solid #dbeafe; }
        .sp-completed { background: #ecfdf5; color: #047857; border: 1px solid #d1fae5; }
        .sp-rejected { background: #fef2f2; color: #b91c1c; border: 1px solid #fee2e2; }
                ...
                <table class="gov-table-premium">
                    <thead>
                        <tr>
                            ...
                            <th class="td-center">Current Status</th>
